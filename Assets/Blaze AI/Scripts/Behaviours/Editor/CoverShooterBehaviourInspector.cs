        ...
        {   
            ...
            foreach (var item in tabs) {
                ...
                if (tabIndex == tabSelected) {
                    // selected button
                    GUILayout.Button(item, selectedStyle, GUILayout.MinWidth(105), GUILayout.Height(45));
                }
                else {
                    // unselected buttons
                    if (GUILayout.Button(item, unselectedStyle, GUILayout.MinWidth(105), GUILayout.Height(45))) {
